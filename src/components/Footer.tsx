...
const Footer = () => {
  return (
    <footer className="bg-[#2B2D31] bg-grid-pattern-dark text-neutral-300 pt-10 md:pt-16 pb-8 md:pb-12 border-t border-[#3F4147] overflow-x-hidden">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-10 mb-10 md:mb-14">
          {/* Brand Info */}
          <div className="lg:col-span-2 space-y-4 md:space-y-5 md:text-left">
            <Link to="/" className="flex items-center gap-3 group">
              <div className="w-10 h-10 md:w-11 md:h-11 bg-white border border-[#3F4147] rounded-xl flex items-center justify-center shadow-md overflow-hidden flex-shrink-0">
                <img src={logoImg} alt="Euro Training Center Logo" className="w-full h-full object-contain" />
              </div>
              <div className="flex flex-col min-w-0">
                <span className="font-heading font-extrabold text-lg md:text-xl leading-none text-white truncate">Euro Training Center</span>
                <span className="text-[11px] md:text-xs text-primary font-extrabold tracking-wider mt-1">NEPAL | Career Institute</span>
              </div>
            </Link>
            
            <div className="p-3 md:p-3.5 bg-[#35373C] rounded-2xl border border-[#3F4147] inline-block w-full">
              <span className="text-[11px] md:text-xs font-heading font-bold text-primary block mb-1">
            ...
            <div className="flex items-center gap-2 pt-1 text-[11px] md:text-xs text-neutral-400">
            ...
            <div className="flex gap-2 md:gap-3 pt-2 md:justify-start justify-start">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-white font-heading font-bold text-sm md:text-base mb-4 md:mb-5 pb-2 border-b border-[#3F4147]">
              Quick Links
            </h3>
            <ul className="space-y-2.5 md:space-y-3 text-xs md:text-sm">
              ...
              <li><Link to="/verify" className="text-neutral-400 hover:text-primary transition-colors flex items-center gap-1.5"><QrCode className="w-3 h-3 md:w-3.5 md:h-3.5 text-primary flex-shrink-0" /> Certificate & QR Verify</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 md:space-y-4 text-xs md:text-sm">
              <li className="flex items-start gap-3">
                ...
                <span className="text-neutral-300 leading-snug">Samakhusi, Kathmandu, Nepal (Near Chowk)</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="p-1.5 rounded bg-[#35373C] text-primary flex-shrink-0 border border-[#3F4147]">
                  <Phone className="w-3.5 h-3.5 md:w-4 md:h-4" />
                </div>
                <div className="flex flex-col font-mono text-neutral-300 min-w-0">
                  <a href="tel:+9779768808890" className="hover:text-primary break-all">+977-9768808890</a>
                  <a href="tel:014975711" className="hover:text-primary text-[11px] text-neutral-400">01-4975711</a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <div className="p-1.5 rounded bg-[#35373C] text-primary flex-shrink-0 border border-[#3F4147] mt-0.5">
                  <Mail className="w-3.5 h-3.5 md:w-4 md:h-4" />
                </div>
                <a href="mailto:eurotraining2075@gmail.com" className="text-neutral-300 hover:text-primary transition-colors text-[11px] md:text-xs break-all font-mono leading-snug">
            ...
            <div className="mt-5 md:mt-6">
              <Link
                to="/contact"
                className="w-full block text-center bg-primary/20 hover:bg-primary border border-primary/50 hover:border-primary text-white py-2.5 px-4 rounded-xl text-[11px] md:text-xs font-bold transition-all shadow-sm active:scale-[0.98] sm:active:scale-100"
              >
        ...
        <div className="border-t border-[#3F4147] pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-4 text-[11px] md:text-xs text-neutral-400 text-center md:text-left">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-2 md:space-x-6 md:flex-nowrap justify-center md:justify-end">
